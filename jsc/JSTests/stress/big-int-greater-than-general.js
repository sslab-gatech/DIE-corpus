...
assert(0x1fffffffffffff01 n > 0x1fffffffffffff02 n, false, "0x1fffffffffffff01n > 0x1fffffffffffff02n");
assert(0x1fffffffffffff02 n > 0x1fffffffffffff01 n, true, "0x1fffffffffffff02n > 0x1fffffffffffff01n");
...
assert(0x10000000000000000 n > 0n, true, "0x10000000000000000n > 0n");
assert(0n > 0x10000000000000000 n, false, "0n > 0x10000000000000000n");
assert(0x10000000000000000 n > 1n, true, "0x10000000000000000n > 1n");
assert(1n > 0x10000000000000000 n, false, "1n > 0x10000000000000000n");
assert(0x10000000000000000 n > BigInt("-1"), true, "0x10000000000000000n > -1n");
assert(BigInt("-1") > 0x10000000000000000 n, false, "-1n > 0x10000000000000000n");
assert(0x10000000000000001 n > 0n, true, "0x10000000000000001n > 0n");
assert(0n > 0x10000000000000001 n, false, "0n > 0x10000000000000001n");
...
assert(0x10000000000000000 n > 0x100000000 n, true, "0x10000000000000000n > 0x100000000n");
assert(0x100000000 n > 0x10000000000000000 n, false, "0x100000000n > 0x10000000000000000n");
...
assert( n > Number.MAX_VALUE, false, " > Number.MAX_VALUE");
assert(Number.MAX_VALUE >  n, true, "Number.MAX_VALUE > ");
assert( n > Number.MAX_VALUE, true, " > Number.MAX_VALUE");
assert(Number.MAX_VALUE >  n, false, "Number.MAX_VALUE > ");
