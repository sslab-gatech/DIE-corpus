...
function TestOperationOrder() {
    ...
    var handler = {
        ...
        has() {
            assertUnreachable("trap 'has' invoked");
        },
        deleteProperty() {
            assertUnreachable("trap 'deleteProperty' invoked");
        },
        ownKeys() {
            assertUnreachable("trap 'ownKeys' invoked");
        },
        apply() {
            assertUnreachable("trap 'apply' invoked");
        },
        construct() {
            assertUnreachable("trap 'construct' invoked");
        },
        getPrototypeOf() {
            assertUnreachable("trap 'getPrototypeOf' invoked");
        },
        setPrototypeOf() {
            assertUnreachable("trap 'setPrototypeOf' invoked");
        },
        isExtensible() {
            assertUnreachable("trap 'isExtensible' invoked");
        },
        preventExtensions() {
        ...
        defineProperty() {
            assertUnreachable("trap 'defineProperty' invoked");
        },
    };
    var P = new Proxy({
        x: 2
