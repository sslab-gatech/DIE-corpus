...
shouldBeAsync("test2", async function() {
    return "test2";
});
...
// Throw completion
async function asyncDeclThrower(e) {
    throw new MyError(e);
}
shouldThrowAsync(() => asyncDeclThrower("boom!"), MyError, "boom!");
shouldThrowAsync(() => (async function(e) {
    throw new MyError(e);
})("boom!!!"), MyError, "boom!!!");
shouldThrowAsync(() => (async e => {
    throw new MyError(e)
})("boom!!"), MyError, "boom!!");
shouldThrowAsync(() => ({
    async thrower(e) {
...
}).thrower("boom!!!!"), MyError, "boom!!!!");

function resolveLater(value) {
    return Promise.resolve(value);
}

function rejectLater(error) {
