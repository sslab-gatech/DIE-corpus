...
for (var i = 0; i < 10000; ++i) {
    [ // integers
        ...
        // doubles
        Number.MIN_VALUE, Number.MAX_VALUE, Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.NaN, Number.EPSILON, +0.0, -0.0, 0.1, -0.1, 4.2, -4.2, 0x80000000 + 0.5, // out of int32_t, double
        // stringified doules
        Number.MIN_VALUE.toString(), Number.MAX_VALUE.toString(), Number.MIN_SAFE_INTEGER.toString(), Number.MAX_SAFE_INTEGER.toString(), Number.POSITIVE_INFINITY.toString(), Number.NEGATIVE_INFINITY.toString(), "NaN", Number.EPSILON.toString(), "+0.0", "-0.0", "0.1", "-0.1", "4.2", "-4.2", (0x80000000 + 0.5).toString()
