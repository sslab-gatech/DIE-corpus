var i; // Check that an entry frame is always aligned properly.

function entryFrame_1() {} // Check rectifier frames are keeping the same alignment.
