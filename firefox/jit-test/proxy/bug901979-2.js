...
var global = this;
var status = "pass"; // This is a little tricky. There are two proxies.
...
var handler = new Proxy({}, metaHandler); // 2. Then we create a proxy using 'handler' as its handler. This means the test
